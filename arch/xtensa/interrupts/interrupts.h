...
/* --- Matrice d'interruptions ESP32 (DPORT) ---
 * Indice de la source UART0_INTR_SOURCE = 5 sur ESP32 classique
 */
#define DPORT_PRO_INTR_MATRIX_BASE 0x3FF10000u
#define DPORT_APP_INTR_MATRIX_BASE 0x3FF11000u

#define CORE0_UART0_MAP_REG (*(volatile uint32_t *)(DPORT_PRO_INTR_MATRIX_BASE + (5 * 4)))
#define CORE1_UART0_MAP_REG (*(volatile uint32_t *)(DPORT_APP_INTR_MATRIX_BASE + (5 * 4)))
