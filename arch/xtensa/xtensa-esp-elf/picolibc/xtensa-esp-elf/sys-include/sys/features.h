...
#if defined(__ZEPHYR__) && !defined(_ZEPHYR_SOURCE) && !defined(_GNU_SOURCE)        \
    && !defined(_BSD_SOURCE) && !defined(_SVID_SOURCE) && !defined(_DEFAULT_SOURCE)
...
#if defined(_ISOC23_SOURCE) || (__STDC_VERSION__ - 0) > 201710L || (__cplusplus - 0) >= 202002L
#define __ISO_C_VISIBLE 2023
#elif defined(_ISOC11_SOURCE) || (__STDC_VERSION__ - 0) >= 201112L || (__cplusplus - 0) >= 201103L
...
#define __XSI_VISIBLE 0
    ...
    && (__OPTIMIZE__ > 0 || defined(__clang__)) && __GNUC_PREREQ__(4, 1) && !defined(_LIBC)
